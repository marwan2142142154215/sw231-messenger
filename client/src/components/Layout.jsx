...
export default function Layout() {
  ...
  return (
    <div className="h-screen w-screen flex overflow-hidden" style={bgStyle}>
      ...
      <button onClick={() => setSidebarOpen(!sidebarOpen)} className={`fixed z-30 w-10 h-10 glass rounded-xl flex items-center justify-center hover:bg-white/10 transition-all ${sidebarOpen ? 'top-4 left-[272px]' : 'top-4 left-4'}`}>
