  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        ...
        <div>
          <p className="font-medium text-sm">{post.author_name || 'Unknown'}</p>
      ...
      <div className="flex items-center gap-6 pt-2 border-t border-white/5">
        <button
          ...
          className={`flex items-center gap-2 text-sm transition-all ${post.isLiked ? 'text-neon-pink' : 'text-gray-400 hover:text-neon-pink'}`}
        >
          <svg className="w-5 h-5" fill={post.isLiked ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
