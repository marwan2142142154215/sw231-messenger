  ...
  return (
    <div className="h-full overflow-y-auto">
      <div className="max-w-2xl mx-auto px-4 py-6 space-y-6">
        ...
        <StoryBar stories={stories} onAdd={() => fileRef.current?.click()} onView={(s) => toast('Story viewer coming soon')} />
        <input ref={fileRef} type="file" accept="image/*,video/*" className="hidden" onChange={handleStoryUpload} />
        ...
        <div className="glass rounded-2xl p-4 space-y-3">
          ...
          <div className="flex items-center justify-between">
            <div className="flex gap-2">
              <button onClick={() => fileRef.current?.click()} className="text-gray-400 hover:text-nyx-400 transition-colors">
